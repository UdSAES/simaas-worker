...
The code works as intended, but the test suite is broken due to a change in how simulations are executed. Will be fixed soon, along with an update of the README.
